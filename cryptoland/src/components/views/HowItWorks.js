  ...
  return(
    <ViewsContent>
      ...
      <div className='page-body'>
        ...
        <p>A smarter network for a smarter generation of business, CryptoLand works as diligently as its users to promote brands and grow wealth by providing both an application and currency that yield multi-faceted benefits for all its members.</p>
      </div>
    </ViewsContent>
  )
}
