  ...
  async componentDidMount() {
    try {
      let coinRes = await axios.get(
        "https://cryptoland.icoadm.in/api/v1/app_info?key=99a4b63abc97857eaf1f92f31ebf07cd",
        {
          headers: {
            "Access-Control-Allow-Origin":
              "https://cryptolandico.com, https://cryptolandico.io, https://cryptoland.io",
            Vary: "Origin",
          },
        }
      );
      ...
      this.setState({
        funds: funds,
        percent: `${Math.floor(
          (1 - endDate.diff(today, "days") / 168) * 100
        )}%`,
      });
    } catch (err) {}
  }
